class BOT_MED
{
    ...
    load()
    {
        const itemId = "BOT_MED"; // unique item id, used in tarkov
        ...
        const itemFleaPrice = 30000000000; // Price of item on Fleamarket
...
module.exports.BOT_MED = BOT_MED;
