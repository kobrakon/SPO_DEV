...
class Attatchments {
    ...
    static LoadAtts() {
        ...
        //Make sure there isn't weird mod generation for bots
        if (config.botChanges == true) {
            ...
            for (let i in itemDB) {
                ...
                if (fileData._id === "5b31163c5acfc400153b71cb"
                    ...
                    fileData._props.Slots[0]._required = true;
                }
            ...
            if (config.logEverything == true) {
                Logger.info("Attatchments loaded");
            }
        }
